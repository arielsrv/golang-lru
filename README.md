...
Full docs are available on [Godoc](http://godoc.org/github.com/arielsrv/golang-lru)
...
[without pool](https://github.com/arielsrv/golang-lru/tree/master)
---
```
...
[with sync pool](https://github.com/arielsrv/golang-lru/tree/feature/syncpool)
---
```
Running tool: /home/liqi/workspace/go/bin/go test -benchmem -run=^$ -coverprofile=/tmp/vscode-govFyHq9/go-code-cover -bench . github.com/arielsrv/golang-lru
...
[with list pool](https://github.com/arielsrv/golang-lru/tree/feature/listpool)
---
```
Running tool: /home/liqi/workspace/go/bin/go test -benchmem -run=^$ -coverprofile=/tmp/vscode-govFyHq9/go-code-cover -bench . github.com/arielsrv/golang-lru
